...
<head>
        <title>Warehouse Management System|| Login Page</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="post">
				 <div class="control-group normal_text"> <h3>Warehouse</strong> <strong style="color: orange">System</strong></h3></div>
